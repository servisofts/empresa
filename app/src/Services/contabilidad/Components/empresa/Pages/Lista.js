    ...
    getContent() {
        ...
        return <STable2
            header={[
                ...
                { key: "key-planc", label: "Plan Cuenta", width: 100, center: true, component: (key) => { return <SView width={35} height={35} onPress={() => { SNavigation.navigate("cuenta_contable", { key_empresa: key }) }}> <SIcon name={'Cheque'} /> </SView> } },
