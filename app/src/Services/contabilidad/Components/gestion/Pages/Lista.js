    ...
    getContent() {
        ...
        return <STable2
            header={[
                ...
                { key: "key-comprobante", label: "Comprobante", width: 70, center: true, component: (key) => { return <SView width={35} height={35} onPress={() => { SNavigation.navigate("comprobante", { key_gestion: key, key_empresa: this.key_empresa }) }}> <SIcon name={'Ajustes'} /> </SView> } },
            ]}
            filter={(data) => {
