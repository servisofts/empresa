...
class Registro extends Component {
    ...
    getContent() {
        ...
        return <SForm
            ...
            inputs={{
                key_cuenta_contable: { label: "Codigo P", defaultValue: this.data["key_cuenta_contable"] ? this.data["key_cuenta_contable"] : this.key_cuenta_contable, type: "text", required: true },
                codigo: { label: "codigo", isRequired: true, defaultValue: defaultCode ? defaultCode : this.data["codigo"] },
